...
public class PostController {
    ...
    @Transactional
    public String readPost(@PathVariable(name = "postId") Long postId, PageRequestDTO pageRequestDTO, Model model,@SessionAttribute(required = false,name = "sessionId")String sessionId, HttpServletRequest httpServletRequest){
        // 오성훈 추가
